import{i as d,g as l,o as g,d as n,a as f,s as r}from"./vendor-451a0b16.js";import{e as m,d as b,r as i,f as o}from"./refs-c790447f.js";const u={apiKey:"AIzaSyCuVjEugcofQtVmUyg1Bm1vmoIkKJ7-dfU",authDomain:"timer-b359e.firebaseapp.com",databaseURL:"https://timer-b359e-default-rtdb.europe-west1.firebasedatabase.app",projectId:"timer-b359e",storageBucket:"timer-b359e.appspot.com",messagingSenderId:"544796112036",appId:"1:544796112036:web:dea584d81b16885d642231"},v=d(u),c=l(v);async function w(t){if(t.isStart){m(i.stopBtn),b(i.startBtn);return}m(i.startBtn),b(i.stopBtn)}let D;const L=t=>{t.isStart?D=setInterval(()=>{const s=Date.now()-t.start;y(s)},10):t.isStart||clearInterval(D)};function y(t){const{minutes:e,secunds:s,milisecunds:a}=o(t);i.watch.innerHTML=`${e}:${s},${a}`}const B=t=>{t.length>0?i.listBtns.classList.add("btns-list-visible"):i.listBtns.classList.remove("btns-list-visible");const e=t.map(s=>`
    <li class="step-item">
      <div>
...
//# sourceMappingURL=firebase-api-35db4bc1.js.map
